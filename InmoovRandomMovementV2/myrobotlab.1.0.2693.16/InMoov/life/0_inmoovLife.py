...
RobotCanBothHands=inmoovLifeConfig.getboolean('BOTHHANDSRANDOM', 'RobotCanBothHands')
...
RobotCanBothArms=inmoovLifeConfig.getboolean('BOTHARMSRANDOM', 'RobotCanBothArms')
